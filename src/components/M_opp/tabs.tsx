...
export default (props:Propos) => {
  ...
  <div className={css`
   display:flex;
    ...
    <Tab isActive={props.activeTab==1?true:false} icon="menu" title="Profile" subtitle="41" />
    <Tab isActive={props.activeTab==2?true:false} icon="research" title="Information Centre" subtitle="" />
