...
export default (props:Propos) => {
    return <div className={Style.hausdfnasjne}>
  ...
  <div className={Style.jasdjkwq3sd}>
    ...
    <Tab isActive={props.activeTab==1?true:false} icon="menu" title="Directory" subtitle="41" />
    <Tab isActive={props.activeTab==2?true:false} icon="glasses" title="Watchlist" subtitle="" />
    <Tab isActive={props.activeTab==3?true:false} icon="puzzle" title="SMART Match" subtitle="" />
